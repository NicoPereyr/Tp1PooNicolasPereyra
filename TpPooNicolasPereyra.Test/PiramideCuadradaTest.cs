...
namespace TpPooNicolasPereyra.Test
{
    ...
    public class PiramideCuadradaTest
    {
        ...
        public void CalcularApotema_EsCorrecto()
        {
            ...
            // Assert
            double esperado = Math.Sqrt(Math.Pow(lado / 2.0, 2) + Math.Pow(altura, 2));
        ...
        public void CalcularAreaTotal_EsCorrecto()
        {
            ...
            // Assert
            double baseArea = Math.Pow(6, 2);
            double apotema = Math.Sqrt(Math.Pow(3, 2) + Math.Pow(4, 2));
            double lateral = 2 * 6 * apotema;
            double esperado = baseArea + lateral;
        ...
        public void CalcularVolumen_EsCorrecto()
        {
            ...
            // Assert
            double esperado = (Math.Pow(9, 2) * 6) / 3.0;
